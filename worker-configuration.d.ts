/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a7af8f03d2a17bc230104c7ff80ee848)
// Runtime types generated with workerd@1.20260305.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "OrgDurableObject";
	}
	interface Env {
		PROFILE_PHOTOS: R2Bucket;
		DB: D1Database;
		RESEND_API_KEY: string;
		ORG_DO: DurableObjectNamespace<import("./src/server").OrgDurableObject>;
	}
}
