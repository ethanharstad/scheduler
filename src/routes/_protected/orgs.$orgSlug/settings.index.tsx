...
function GeneralSettingsPage() {
  ...
  return (
    <div>
      <h1 className="text-xl font-bold text-navy-700 mb-1">General</h1>
      <p className="text-sm text-gray-500 mb-6">Organization-wide configuration.</p>

      <div className="border border-gray-200 rounded-lg bg-white p-6 max-w-lg">
        <form onSubmit={(e) => void handleSubmit(e)} className="space-y-5">
          <div>
            ...
            <p className="text-xs text-gray-500 mb-2">
              The time that marks the start of a scheduling day. Use 07:00 for departments running 24-hour
              shifts from 0700 to 0700.
            </p>
            <input
              id="scheduleDayStart"
              type="time"
