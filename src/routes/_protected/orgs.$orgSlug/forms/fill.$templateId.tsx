...
function FillForm() {
  ...
  function setValue(key: string, val: string | number | boolean | string[] | null) {
...
function FormFields({
  ...
  onChange: (key: string, val: string | number | boolean | string[] | null) => void
  prefix: string
}) {
  // Evaluate conditions
...
function RepeatingGroupField({
  ...
  function removeEntry(idx: number) {
    ...
    // Clear values for this entry and shift down
