...
export type CreateScheduleRequirementInput  = { orgSlug: string; name: string; positionId?: string | null; minStaff: number; maxStaff?: number | null; effectiveStart: string; effectiveEnd?: string | null; rrule: string; windowStartTime?: string | null; windowEndTime?: string | null; windowEndDayOffset?: number | null; sortOrder?: number }
...
export type UpdateScheduleRequirementInput  = { orgSlug: string; requirementId: string; name: string; positionId?: string | null; minStaff: number; maxStaff?: number | null; effectiveStart: string; effectiveEnd?: string | null; rrule: string; windowStartTime?: string | null; windowEndTime?: string | null; windowEndDayOffset?: number | null; sortOrder?: number }
